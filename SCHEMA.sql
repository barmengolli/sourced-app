...
-- =============================================================
-- Outreach daily ingestion v2
-- migrations/2026-08-20_outreach_daily_ingestion.sql
-- STATUS: PENDING.
-- =============================================================
-- One complete, closed America/Denver day per sequence. Missing metrics remain
-- NULL rather than being coerced to zero. The workflow writes through the
-- service-role-only RPC after Google Sheets QA and an explicit apply gate.
-- The legacy outreach_snapshots weekly feed remains the live dashboard source
-- until the documented daily-to-weekly reconciliation gate is satisfied.
